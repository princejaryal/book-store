  ...
  return (
    <>
      ...
      <section className="flex flex-wrap gap-6">
        <div className="flex flex-col w-full md:w-3/3 xl:w-4/4 bg-white shadow rounded-lg">
          <div className="px-6 py-5 font-semibold border-b border-gray-100 text-center">The number of orders per month</div>
      ...
      <section className="text-right font-semibold text-gray-500">
        <a href="#" className="text-purple-600 hover:underline">Recreated</a> with <a href="https://tailwindcss.com/" className="text-teal-400 hover:underline">Tailwind CSS</a> by Prince Jaryal
      </section>
    </>
  )
}
